...
class myDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(ctx) {
    ...
    try {
      ...
      const props = await next_document__WEBPACK_IMPORTED_MODULE_1___default.a.getInitialProps(ctx); // ctx.renderPage = () => {
      // }

      return _objectSpread({}, props, {
        styled: __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, props.styles, sheet.getStyleElement())
      });
    } finally {
      sheet.seal();
    }
